...
speed_coef = 1
vertical_position = 0
vertical_position_coef = 0.1
vertical_position_changed = False
horizontal_speed = 0
horizontal_speed_coef = 2
camera_heading = 0
...
def update_buttons(buttons_list):
    ...
    global vertical_position_changed
    global horizontal_speed


    # speed is moving forward/backward
    if buttons_list[2] == 1 and buttons_list[1] == 0:
        speed = speed + speed_coef
        speed = min(speed, 15)  # limit speed by 20

    if buttons_list[2] == 0 and buttons_list[1] == 1:
        speed = speed - speed_coef
        speed = max(speed, -5)  # limit speed by 5
    if buttons_list[2] == 1 and buttons_list[1] == 1:
        speed = 0
...
def update_drone():
    ...
    vx = speed * math.cos(yaw_drone) + horizontal_speed * math.sin(yaw_drone)
    vy = speed * math.sin(yaw_drone) + horizontal_speed * -math.cos(yaw_drone)
